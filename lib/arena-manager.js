...
function createArenaManager() {
    ...
    function normalizeCountryCode(code) {
        ...
        return DEFAULT_COUNTRIES[normalized] ? normalized : "GLOBAL";
    }
    ...
    function getCountryMeta(code) {
        ...
        return {
            code: normalized,
            name: DEFAULT_COUNTRIES[normalized]?.name || DEFAULT_COUNTRIES.GLOBAL.name,
            flag: DEFAULT_COUNTRIES[normalized]?.flag || DEFAULT_COUNTRIES.GLOBAL.flag
        };
    }
    ...
    function createArenaPlayer(userData, previousRecord = null, countryCode = "GLOBAL") {
    ...
    function updateHOF(player) {
        ...
        const merged = {
            ...
            name: player.name,
            avatar: player.avatar,
            countryCode: player.countryCode || "GLOBAL",
