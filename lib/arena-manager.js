...
function createArenaManager() {
    ...
    function applyDamageConsequences(attacker, target, damage, now = Date.now()) {
        ...
        if (now >= (target.invulnerableUntil || 0)) {
            ...
            // El atacante sigue viéndose épico (lanzó un poder inmenso), pero el pequeñito no es borrado instantáneamente.
            if (target.score < 1000 && attacker.score > (target.score * 3)) {
