...
function syncTikTokEnvFromChrome(options = {}) {
    ...
    if (process.platform !== "darwin") {
        logger.log("[tiktok-auth] ℹ️ La sincronización automática de Chrome solo está disponible en macOS. En Windows, por favor actualiza TIKTOK_SESSION_ID en el archivo .env manualmente si el Live no conecta.");
