const GAME_CONFIG = {
    ...
    arena: {
        roundDurationSeconds: 5 * 60, // 5 minutos por ronda
        maxHp: 1000,
        ...
        idleVisualAfterMs: 3 * 60 * 1000, // Idle visual tras 3 minutos
        ...
        arenaBroadcastDelayMs: 12, // Optimizado al máximo (12ms) para respuesta visual instantánea
