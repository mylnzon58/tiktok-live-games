const GAME_CONFIG = {
    ...
    arena: {
        ...
        arenaBroadcastDelayMs: 50, // Reducido de 25 para optimizar performance y evitar lag
        centerBonusLabel: "ZONA REY",
        circleRadius: 350, // Ajustado a 350 para que quepa perfecto en 800x1350
        beginnerLikeScorePerTap: 5, // Taps valen 5 para principiantes
        catchUpMultiplier: 1.8, // Multiplicador para nuevos jugadores
        catchUpScoreThreshold: 250 // Hasta qué puntaje aplica el catch-up
    }
};
