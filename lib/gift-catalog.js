...
const TIER_DEFAULTS = [
    { max: 1, tier: "free", category: "tap", rarity: "common", scoreScale: 0.3, damageScale: 6, sizeScale: 0.06, knockback: 0.12, fx: "tapSpark", sfx: "hit", label: "Tap" },
    { max: 20, tier: "small", category: "projectile", rarity: "common", scoreScale: 0.65, damageScale: 14, sizeScale: 0.12, knockback: 0.22, fx: "projectile", sfx: "roseShot", label: "Disparo" },
    { max: 299, tier: "medium", category: "shockwave", rarity: "uncommon", scoreScale: 1.55, damageScale: 36, sizeScale: 0.26, knockback: 0.6, fx: "shockwave", sfx: "hit", label: "Impacto" },
    { max: 999, tier: "large", category: "fire", rarity: "rare", scoreScale: 2.9, damageScale: 72, sizeScale: 0.46, knockback: 0.85, fx: "fireBurst", sfx: "fire", label: "Estallido" },
    { max: 9999, tier: "epic", category: "lightning", rarity: "epic", scoreScale: 12.0, damageScale: 350, sizeScale: 0.8, knockback: 1.2, fx: "lightning", sfx: "lightning", label: "Rayo" },
    { max: Infinity, tier: "legendary", category: "mega", rarity: "mythic", scoreScale: 60.0, damageScale: 1500, sizeScale: 1.5, knockback: 2.5, fx: "megaBlast", sfx: "heavyExplosion", label: "Megablast" }
];
